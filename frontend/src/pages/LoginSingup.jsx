    ...
    <div className=' flex h-[100vh] bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 ...'>
        ...
        <div className='flex flex-col mt-10 gap-[25px]'>
            ...
            <div className='flex items-center m-auto w-[480px] h-[50px]  bg-gray-300 rounded-[6px]'>
                ...
                <input className='h-8 w-[400px] bg-transparent border-none text-xl	text-white' placeholder='password' type="password"  />
            </div>
            ...
            <div  className='p-2.5 bg-violet-600 text-sm cursor-pointer text-white rounded-[15px]'  onClick={() => {setAction("sing up")}} >sing up</div>
                <div className = 'p-2.5 bg-violet-600 text-sm cursor-pointer text-white rounded-[15px]' onClick={() => {setAction("login") }}  >login</div>
            </div>
        </div>
